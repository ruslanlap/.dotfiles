# Generated by Powerlevel10k configuration wizard on 2025-02-11 at 13:31 EET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 31091.
# Wizard options: nerdfont-v3 + powerline, large icons, lean_8colors, unicode, 24h time,
# 2 lines, solid, left frame, green-ornaments, compact, many icons, concise,
